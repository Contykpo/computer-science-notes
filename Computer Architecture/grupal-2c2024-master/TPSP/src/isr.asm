...
_isr14:
    ...
    mov ebx, cr2            ;Guardamos cr2 antes de que pueda ocurrir otro page-fault
                            ;ebx = Direccion virtual que genero el page-fault

    mov eax, [error_code]   ;eax = error code
    not eax
    and eax, 0x1       
    cmp eax, 0x1            ;Si el bit mas bajo del error code esta seteado, entonces el page-fault no fue por missing page
    jne .not_missing_page

    push ebx

    call page_fault_handler

    add esp, 4              ;Pop parametro
...
global _isr98
_isr98:
    mov eax, 0x62      ; Modificamos el valor de eax
    iret               ; Retornamos la interrupcion
